...
Feature: PRIIPS_Workflows
   ...
   @IMPRESS-13945
    ...
    Examples:
      ...
      | imen.messaoudi  | NeoxamMess@2424   | Mois d'arrêté;Document;Juridiction;Langue;Code Ptf. | 2022-12;PRIIPS-COSTS-RIY-COMPUTATION;lu;en;001915  | Attente des calculs de risque et de la performance | success  |3000000    |Audit          | finished    | 3000000 | 001915_2022-12-31_PRIIPS-COSTS-RIY-COMPUTATION_lu_audit_v1 |
